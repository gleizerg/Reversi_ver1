...
public class MatchController {
    ...
    public void restartCurrentMatch(){
        initiateMatchBoard();
        ActivityMatch.cleanBoardAndDisplayStartingPosition();
        ActivityMatch.updateScoreOnDisplay(2,2);
        makeFirstMove();
    }

    public void playMove(BoardPosition position, ActivityMatch activityMatch){// for onClick listeners
    ...
    private void playUser(BoardPosition position){
        ...
        ActivityMatch.updateScoreOnDisplay(getAmountOfBlackSlots(), getAmountOfWhiteSlots());
    }
    ...
    private void gameOver(ActivityMatch activityMatch){
